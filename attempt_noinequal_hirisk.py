...
# how does homophily change things at high risk?
...
'''
suffixV = [ '_h00', '_h02', '_h04', '_h06', '_h08', '_h10' ]
hV =      [     0,   0.2,     0.4,     0.6,   0.8,    1  ]
rV =      [   0.9,   0.9,   0.9,   0.9,   0.9,   0.9 ]
'''
suffixV = [ '_h083', '_h086', '_h089', '_h092', '_h095', '_h098' ]
hV =      [     0.83,   0.86,     0.89,     0.92,   0.95,    0.98  ]
rV =      [   0.9,   0.9,   0.9,   0.9,   0.9,   0.9 ]
...
for suffix, h, r in zip(suffixV, hV, rV):
    ...
    plt.axis('scaled')
    plt.tight_layout()
    plt.savefig('attempt_noinequal' + suffix + '.pdf')
    plt.close()
